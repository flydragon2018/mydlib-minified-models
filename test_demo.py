...
# annotations
train_labels ="labels_ibug_300W_train_neck.xml"
test_labels = "labels_ibug_300W_train_neck.xml"
...
def test(image_path, model_path):
    ...
    #using custom trained object detector, just for pipeline solution
...
#test("test_image.jpg", "eye_eyebrows_22.dat")

#test("test.jpg", "neck_5.dat")


test("bald_guys.jpg", "neck_5.dat")
